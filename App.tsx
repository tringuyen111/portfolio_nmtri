...
const App: React.FC = () => {
  ...
  return (
    <div className="bg-brand-background font-sans text-brand-text">
      ...
      {isEditing && editingItem?.type === 'project' && <ProjectEditModal project={editingItem.data} onSave={handleSaveProject} onClose={handleCloseModal} title={editingItem.data === 'new' ? currentLangContent.modals.addProjectTitle : currentLangContent.modals.editProjectTitle} saveButtonText={currentLangContent.modals.saveProject} labels={{url: currentLangContent.modals.projectUrlLabel, role: currentLangContent.modals.projectRoleLabel, client: currentLangContent.modals.projectClientLabel, date: currentLangContent.modals.projectDateLabel, deliverables: currentLangContent.modals.projectDeliverablesLabel, imageResolutionWarning: currentLangContent.modals.imageResolutionWarning, title: currentLangContent.modals.projectTitleLabel, description: currentLangContent.modals.projectDescriptionLabel, technologies: currentLangContent.modals.projectTechnologiesLabel}} />}
